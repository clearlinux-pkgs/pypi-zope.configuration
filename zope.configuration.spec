...
cd %{_builddir}/zope.configuration-4.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582848725
...
cp %{_builddir}/zope.configuration-4.3.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/zope.configuration/a0b53f43aab58b46bf79ba756c50771c605ab4c5
