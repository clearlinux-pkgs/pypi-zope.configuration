...
Source0  : https://files.pythonhosted.org/packages/bd/96/c27dfa37f7d8bcef63b5889b0102ecdca0f54f6c65ff9f7c6c39e5db2381/zope.configuration-5.0.1.tar.gz
...
%prep
%setup -q -n zope.configuration-5.0.1
cd %{_builddir}/zope.configuration-5.0.1
pushd ..
cp -a zope.configuration-5.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707758724
